 ...
 */
export declare type FactoryFunction<Entity extends ObjectLiteral, Context> = (faker: typeof Faker, context?: Context) => Entity;
/**
 * EntityProperty defines an object whose keys and values must be properties of the given Entity.
 */
export declare type EntityProperty<Entity extends ObjectLiteral> = {
    [Property in keyof Entity]?: Entity[Property];
};
/**
 * Factory gets the EntityFactory to the given Entity and pass the context along
 */
export declare type Factory = <Entity extends ObjectLiteral, Context>(entity: ObjectType<Entity>) => (context?: Context) => EntityFactory<Entity, Context>;
/**
