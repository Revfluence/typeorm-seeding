...
export declare class EntityFactory<Entity extends ObjectLiteral, Context> {
    name: string;
    entity: ObjectType<Entity>;
    private factory;
    private context?;
    private mapFunction;
    constructor(name: string, entity: ObjectType<Entity>, factory: FactoryFunction<Entity, Context>, context?: Context | undefined);
    /**
